...
// in tractian/test/src/data/services/local/location_local_service_test.dart.
...
import 'package:tractian/src/core/database/database_helper.dart' as _i4;
...
class MockDatabaseHelper extends _i1.Mock implements _i4.DatabaseHelper {
  ...
  @override
  _i3.Future<void> saveBatch(
    _i2.Database? db,
    String? table,
    List<Map<String, dynamic>>? data,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#saveBatch, [db, table, data]),
  ...
  @override
  _i3.Future<List<T>> getAll<T>(
    _i2.Database? db,
    String? table,
    T Function(Map<String, dynamic>)? fromMap,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#getAll, [db, table, fromMap]),
            returnValue: _i3.Future<List<T>>.value(<T>[]),
          )
          as _i3.Future<List<T>>);

  @override
  _i3.Future<List<T>> getByField<T>(
    _i2.Database? db,
    String? table,
    String? field,
    String? value,
    T Function(Map<String, dynamic>)? fromMap,
      ...
      (super.noSuchMethod(
            Invocation.method(#getByField, [db, table, field, value, fromMap]),
            returnValue: _i3.Future<List<T>>.value(<T>[]),
          )
          as _i3.Future<List<T>>);

  @override
  _i3.Future<List<T>> queryList<T>(
    _i2.Database? db,
    String? table,
    String? where,
  ...
  @override
  _i3.Future<Set<T>> fetchBulk<T>({
    required _i2.Database? db,
